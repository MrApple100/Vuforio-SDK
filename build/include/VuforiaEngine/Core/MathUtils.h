...
/// \brief Get a perspective projection matrix and return the result (using a GL CS convention, z negative)
/**
 * \note The field of view is specified in degrees.
 */
VU_API VuMatrix44F VU_API_CALL vuMatrix44FPerspective(float fovy, float aspectRatio, float nearPlane, float farPlane);

/// \brief Create an orthographic projection matrix and return the result (using a GL CS convention, z negative)
...
/// \brief Create a look at model view matrix and return the result
