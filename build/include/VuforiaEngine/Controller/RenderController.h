 ...
 * vuRenderControllerSetVideoBackgroundViewportMode() will override any previously set viewport
 */
VU_API VuResult VU_API_CALL vuRenderControllerSetVideoBackgroundViewportMode(VuController* controller, VuVideoBackgroundViewportMode vbMode);
 ...
 * \note Before calling this function, the render view must be configured by calling vuRenderControllerSetRenderViewConfig, otherwise this call may fail.
 */
VU_API VuResult VU_API_CALL vuRenderControllerGetVideoBackgroundViewInfo(const VuController* controller, VuVideoBackgroundViewInfo* viewInfo);

/// \brief Update the texture data to use for rendering the video background
VU_API VuResult VU_API_CALL vuRenderControllerUpdateVideoBackgroundTexture(VuController* controller, const VuState* state, const VuRenderVideoBackgroundData* renderVBData);
