 ...
 */
VU_API VuResult VU_API_CALL vuPlatformControllerConvertPlatformViewOrientation(const VuController* controller, const void* platformOrientation, VuViewOrientation* vuOrientation);
 ...
 */
VU_API VuResult VU_API_CALL vuPlatformControllerGetFusionProviderPlatformType(const VuController* controller, VuFusionProviderPlatformType* fusionProviderPlatformType);
