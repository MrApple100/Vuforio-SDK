...
VU_ENUM(VuCylinderTargetCreationError)
{
    ...
    VU_CYLINDER_TARGET_CREATION_ERROR_TARGET_NOT_FOUND      = 0x5, ///< Specified target not found in database
 ...
 */
VU_API VuResult VU_API_CALL vuEngineCreateCylinderTargetObserver(VuEngine* engine, VuObserver** observer, const VuCylinderTargetConfig* config, VuCylinderTargetCreationError* errorCode);
...
/// \brief Get the axis-aligned bounding box associated to the target from a Cylinder Target observer, relative to the target's frame of reference
...
/// \brief Get the motion hint associated to the target from a Cylinder Target observer
VU_API VuResult VU_API_CALL vuCylinderTargetObserverGetMotionHint(const VuObserver* observer, VuMotionHint* motionHint);

/// \brief Set the motion hint associated to the target from a Cylinder Target observer
/**
 * \note This operation will reset any tracking operation for a Cylinder Target observer
 ...
 */
VU_API VuResult VU_API_CALL vuCylinderTargetObserverSetMotionHint(VuObserver* observer, VuMotionHint motionHint);
...
VU_API VuResult VU_API_CALL vuCylinderTargetObservationGetStatusInfo(const VuObservation* observation, VuCylinderTargetObservationStatusInfo* statusInfo);

/// \brief Get target info associated with a Cylinder Target observation
VU_API VuResult VU_API_CALL vuCylinderTargetObservationGetTargetInfo(const VuObservation* observation, VuCylinderTargetObservationTargetInfo* targetInfo);
