...
VU_ENUM(VuCloudImageTargetCreationError)
{
    ...
    VU_CLOUD_IMAGE_TARGET_CREATION_ERROR_SERVICE_MISSING_AUTHENTICATION = 0x4, ///< Missing authentication details (user authentication or authentication secret)
 ...
 */
VU_API VuResult VU_API_CALL vuEngineCreateCloudImageTargetObserver(VuEngine* engine, VuObserver** observer, const VuCloudImageTargetConfig* config, VuCloudImageTargetCreationError* errorCode);
 ...
 */
VU_API VuResult VU_API_CALL vuCloudImageTargetObserverRegisterHandlers(VuObserver* observer, VuCloudImageTargetObservationsHandler* observationHandler, VuCloudImageTargetQueryErrorHandler* errorHandler, void* clientData);
...
VU_API VuResult VU_API_CALL vuCloudImageTargetObservationGetTargetInfo(const VuObservation* observation, VuCloudImageTargetObservationTargetInfo* targetInfo);
...
VU_API VuResult VU_API_CALL vuEngineCreateImageTargetObserverFromCloudObservation(VuEngine* engine, VuObserver** observer, const VuImageTargetCloudObservationConfig* config, VuImageTargetCloudObservationCreationError* errorCode);
