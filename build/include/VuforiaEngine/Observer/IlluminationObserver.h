 ...
 * \brief Value used in the VuIlluminationObservationInfo data structure to indicate that scene ambient intensity is not supported on the current platform
 */
 ...
 * \brief Value used in the VuIlluminationObservationInfo data structure to indicate that scene ambient color temperature is not supported on the current platform
 */
...
VU_API VuResult VU_API_CALL vuEngineCreateIlluminationObserver(VuEngine* engine, VuObserver** observer, const VuIlluminationConfig* config, VuIlluminationCreationError* errorCode);
...
VU_API VuResult VU_API_CALL vuIlluminationObservationGetInfo(const VuObservation* observation, VuIlluminationObservationInfo* illuminationInfo);
