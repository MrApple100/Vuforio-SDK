...
VU_ENUM(VuImageTargetCreationError)
{
    ...
    VU_IMAGE_TARGET_CREATION_ERROR_TARGET_NOT_FOUND      = 0x5, ///< Specified target not found in database
...
VU_ENUM(VuImageTargetBufferCreationError)
{
    ...
    VU_IMAGE_TARGET_BUFFER_CREATION_ERROR_INVALID_FORMAT        = 0x5, ///< Invalid pixel format. Supported formats are VU_IMAGE_PIXEL_FORMAT_GRAYSCALE,
 ...
 */
VU_API VuResult VU_API_CALL vuEngineCreateImageTargetObserver(VuEngine* engine, VuObserver** observer, const VuImageTargetConfig* config, VuImageTargetCreationError* errorCode);

/// \brief Create an Image Target observer from file configuration
VU_API VuResult VU_API_CALL vuEngineCreateImageTargetObserverFromFileConfig(VuEngine* engine, VuObserver** observer, const VuImageTargetFileConfig* config, VuImageTargetFileCreationError* errorCode);

/// \brief Create an Image Target observer from buffer configuration
VU_API VuResult VU_API_CALL vuEngineCreateImageTargetObserverFromBufferConfig(VuEngine* engine, VuObserver** observer, const VuImageTargetBufferConfig* config, VuImageTargetBufferCreationError* errorCode);
...
/// \brief Get the axis-aligned bounding box associated to an Image Target from its respective observer, relative to the target's frame of reference
...
/// \brief Get the motion hint associated to the target from a Image Target observer
VU_API VuResult VU_API_CALL vuImageTargetObserverGetMotionHint(const VuObserver* observer, VuMotionHint* motionHint);

/// \brief Set the motion hint associated to the target from a Image Target observer
/**
 * \note This operation will reset any tracking operation for a Image Target observer
 ...
 */
VU_API VuResult VU_API_CALL vuImageTargetObserverSetMotionHint(VuObserver* observer, VuMotionHint motionHint);
...
VU_API VuResult VU_API_CALL vuImageTargetObservationGetTargetInfo(const VuObservation* observation, VuImageTargetObservationTargetInfo* targetInfo);

/// \brief Get status info associated with an Image Target observation
VU_API VuResult VU_API_CALL vuImageTargetObservationGetStatusInfo(const VuObservation* observation, VuImageTargetObservationStatusInfo* statusInfo);
